...
class Status(object):
  ...
  def GetCreatedAtInSeconds(self):
    ...
    '''
    # api.Search returns times in another format; use that for now
    return time.mktime(time.strptime(self.created_at, '%a, %d %b %Y %H:%M:%S +0000'))
...
#     elif delta < (60 * (1/fudge)):
#       return 'for %d sekunder siden' % (delta)
#     elif delta < (60 * fudge):
#       return 'for omkring et minut siden'
#     elif delta < (60 * 60 * (1/fudge)):
#       return 'for %d minutter siden' % (delta / 60)
#     elif delta < (60 * 60 * fudge):
#       return 'for omkring en time siden'
#     elif delta < (60 * 60 * 24 * (1/fudge)):
#       return 'for %d timer siden' % (delta / (60 * 60))
#     elif delta < (60 * 60 * 24 * fudge):
#       return 'for omkring en dag siden'
#     else:
#       return 'for %d dage siden' % (delta / (60 * 60 * 24))
...
class Api(object):
  ...
  def Search(self, terms=None, from_user=None, to_user=None, hashtag=None, since_id=None, lang=None):
    '''Fetch the public twitter.Status messages hits for search terms.
